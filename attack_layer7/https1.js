...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;HTTPS1-BYPASS https://example.com/ 60`")
...
exec(`node https1.js GET ${host} utils/http.txt ${duration} 64 100`, (error, stdout, stderr) => {
});
