...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;HTTPS2-BYPASS https://example.com/ 60`")
...
exec(`node https2.js ${host} ]${duration} 300`, (error, stdout, stderr) => {
});
